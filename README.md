...
- `docs/prd.md`：产品视角、快速体验、接口概览
- `docs/design-doc.md`：架构设计、模块边界、插件开发指南
- `docs/ops-guide.md`：部署、配置、探活、排障
- `docs/apply-selection-mechanism.md`：Apply 勾选与预览执行机制说明
- `scripts/demo/README.md`：本地演示脚本使用顺序
